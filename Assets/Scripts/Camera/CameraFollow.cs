...
public class CameraFollow : CameraComponent
{
    ...
    [Space(10)]
    [SerializeField] private float rotationLockSpeed;
    ...
    private void FixedUpdate()
    {
        ...
        if (velocity.magnitude > rotationLockSpeed)
    ...
    public override void SetProperties(RaceCar raceCar, Camera camera)
    {
        base.SetProperties(raceCar, camera);

        target = raceCar.transform;
        rigidbody = raceCar.Rigidbody;
    }
}
